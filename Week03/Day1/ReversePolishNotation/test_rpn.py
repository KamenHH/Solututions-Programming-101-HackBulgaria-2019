...
from rpn import _evaluate
from rpn import int_or_float
...
class TestReversedPolishNotation(unittest.TestCase):
    def test_when_float_number_has_no_remainder_return_int(self):
        n = 9.0
        expected_result = 9
        self.assertEqual(int_or_float(n), expected_result)
    ...
    def test_when_two_integers_are_passed_to_evaluate_return_their_sum(self):
        ...
        operator = '+'
        expected_result = 6
        self.assertEqual(_evaluate(op1, op2, operator), expected_result)
